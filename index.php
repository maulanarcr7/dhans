...
<body id="top">
  <header class="bg-light">
    <nav class="navbar navbar-expand-lg navbar-light bg-light" id="header-nav" role="navigation">
      <div class="container"><a class="link-dark navbar-brand site-title mb-0" href="#"><img src="./images/logo-sec.png" alt="" width="150px">ID</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          </ul><a class="btn btn-primary" href="#contact">Mulai Sekarang</a>
        </div>
      </div>
    </nav>
  </header>
  <div class="page-content">
    <div id="content">
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="mt-5 pt-lg-5">
                  <h1 class="intro-title marker" data-aos="fade-left" data-aos-delay="50">Solusi tepat untuk mitra Marketing Anda! </h1>
                  <p class="lead fw-normal mt-4" data-aos="fade-up" data-aos-delay="100">Dhans ID ialah Digital Marketing Agency yang bertujuan untuk membantu para pengusaha baik itu UMKM ataupun Corporate untuk membantu memasarkan produk dan layanannya melalui Dunia Digital.</p>
                  <div class="mt-3" data-aos="fade-up" data-aos-delay="200"><a class="btn btn-primary shadow-sm mt-1 me-2" href="#contact">Mulai Sekarang <i class="fas fa-arrow-right ms-1"></i></a><a class="btn btn-outline-secondary mt-1" data-bigpicture="{&quot;ytSrc&quot;: &quot;aqz-KE-bpKQ&quot;}" href="#"><i class="fas fa-play-circle me-1"></i> Watch Video</a></div>
                </div>
              </div>
      ...
      <div class="section pt-3 pt-lg-5 px-2 px-lg-4" id="about">
        <div class="container-narrow">
          <div class="text-center mb-4">
            <h2 class="marker marker-center">Mulai Usaha Anda Dengan Kami</h2>
          </div>
          <div class="text-center">
            <p class="mx-auto mb-3" style="max-width:800px">Dhans ID memberikan layanan untuk membantu usaha Anda untuk terjun ke Dunia Digital.</p>
          </div>
        </div>
        <div class="container">
          <div class="row py-3">
            <div class="col-md-6 col-lg-3 text-center" data-aos="fade-up" data-aos-delay="100">
              <div class="border rounded p-3 bg-light mb-3">
                ...
                <p class="text-small">Mulai ide bisnis Anda dengan Tim Design kami sehingga Design produk atau jasa yang Anda miliki menjadi lebih menarik..</p>
              </div>
            </div>
            <div class="col-md-6 col-lg-3 text-center" data-aos="fade-up" data-aos-delay="200">
              <div class="border rounded p-3 bg-light mb-3">
                ...
                <h3 class="h4 mt-2">Planning</h3>
                <p class="text-small">Rencanakan ide bisnis Anda dengan Dhans ID! <br> Solusi tepat untuk memasarkan Usahamu di Dunia Digital!</p>
              </div>
            </div>
            <div class="col-md-6 col-lg-3 text-center" data-aos="fade-up" data-aos-delay="300">
              <div class="border rounded p-3 bg-light mb-3">
                ...
                <p class="text-small">Tim Marketing Dhans ID menjamin produk dan layananmu akan menjadi lebih dikenal banyak orang di Dunia Digital!</p>
              </div>
            </div>
            <div class="col-md-6 col-lg-3 text-center" data-aos="fade-up" data-aos-delay="400">
              <div class="border rounded p-3 bg-light mb-3">
                ...
                <p class="text-small">Layanan konsultasi dengan Dhans ID kapan saja dan dimana saja<br>Jangan ragu untuk memasarkan usaha Anda ke Dunia Digital..</p>
              </div>
            </div>
          </div>
        </div>
        <div class="container">
          <div class="row py-3 py-lg-5">
            ...
            <div class="col-lg-6 col-md-7 px-2" data-aos="zoom-in" data-aos-delay="100">
              <div class="h3 mb-2">Ayok mulai dengan <strong>Dhans ID</strong> untuk menganalisa semua kebutuhanmu.</div>
              <p class="text-secondary mb-3">Tim Dhans ID berperan aktif untuk membantu memasarkan produk dan layanan Anda ke Dunia Digital. Selain itu Kami juga memberikan layanan seperti..</p>
              <div class="row">
                <div class="col-lg-6 mb-2">
                  <div class="border border-3 rounded px-2 py-2 d-flex align-items-center">
                    ...
                    <div class="text-secondary fw-bold">Active Discussion</div>
                  </div>
                </div>
                <div class="col-lg-6 mb-2">
                  <div class="border border-3 rounded px-2 py-2 d-flex align-items-center">
                    <div class="badge bg-success me-2"><i class="fas fa-check"></i></div>
                    <div class="text-secondary fw-bold">On-Schedule Planning</div>
                  </div>
                </div>
                <div class="col-lg-6 mb-2">
                  <div class="border border-3 rounded px-2 py-2 d-flex align-items-center">
          ...
          <div class="row py-3 py-lg-5">
            ...
            <div class="col-lg-6 col-md-7 px-2" data-aos="zoom-in" data-aos-delay="100">
              <div class="h3 mb-2">Tim <strong>Dhans ID</strong> siap memberikan layanan terbaik.</div>
              <p class="text-secondary mb-2">Dhans ID memberikan juga kesempatan untuk menjalin kerjasama untuk membantu Anda dalam pemasaran digital atau membantu mengatur strategi serta kelayakan tim internal bisnis Anda dibidang Digital Marketing..</p>
            </div>
          </div>
          <div class="row py-3 py-lg-5">
            ...
            <div class="col-lg-6 col-md-7 px-2" data-aos="zoom-in" data-aos-delay="100">
              <div class="h3 mb-2">Kami percaya dengan Anda untuk <strong>bekerja sama</strong>.</div>
              <p class="text-secondary mb-3">Selain memberikan layanan pemasaran Digital, Kami juga membuka kesempatan untuk menjalin kerjasama bisnis Anda dengan Kami.</p>
              <ul class="nav nav-tabs nav-fill" role="tablist">
                <li class="nav-item" role="presentation"><a class="nav-link p-1 active" aria-current="page" href="#experience" data-bs-toggle="tab"><span class="badge bg-secondary me-1">1</span> Magang PKL</a></li>
                <li class="nav-item" role="presentation"><a class="nav-link p-1" href="#flexibility" data-bs-toggle="tab"><span class="badge bg-secondary me-1">2</span> Bisnis UMKM</a></li>
                <li class="nav-item" role="presentation"><a class="nav-link p-1" href="#results" data-bs-toggle="tab"><span class="badge bg-secondary me-1">3</span> Pelatihan & Konsultan</a></li>
              </ul>
              <div class="tab-content border border-top-0 text-secondary p-3" id="myTabContent">
                <div class="tab-pane fade show active" id="experience" role="tabpanel" aria-labelledby="home-tab">
                  <p>Program Magang atau PKL.</p>
                  <p>Dhans ID memberikan kesempatan dengan Anda untuk memulai magang bersama Kami.</p><a class="fw-bold text-decoration-none" href="#contact">Learn More<i class="fas fa-arrow-right ms-1"></i></a>
                </div>
                <div class="tab-pane fade" id="flexibility" role="tabpanel" aria-labelledby="profile-tab">
                  <p>Bisnis UMKM</p>
                  <p>Dhans ID memberikan kesempatan untuk menjalin kerjasama dengan Anda untuk membantu meningkatkan bisnis UMKM Anda dengan Sharing Profit.</p><a class="fw-bold text-decoration-none" href="#contact">Learn More<i class="fas fa-arrow-right ms-1"></i></a>
                </div>
                <div class="tab-pane fade" id="results" role="tabpanel" aria-labelledby="contact-tab">
                  <p>Pelatihan dan Konsultan.</p>
                  <p>Dhans ID siap untuk memberikan pelatihan dan konsultasi pemasaran digital untuk perusahaan atau organisasi Anda.</p><a class="fw-bold text-decoration-none" href="#contact">Learn More<i class="fas fa-arrow-right ms-1"></i></a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="section py-3 py-lg-5 px-2 px-lg-4" id="clients">
        <div class="container-narrow">
          <div class="text-center mb-4">
            <h2 class="marker marker-center">Clients & Partner</h2>
          </div>
          <div class="text-center">
            <p class="mx-auto mb-3" style="max-width:800px">Jalin kerjasama dengan Dhans Media Sinergi.</p>
          </div>
      ...
      <div class="section bg-light py-3 py-lg-5 px-2 px-lg-4" id="services">
        <div class="container-narrow">
          ...
          <div class="text-center">
            <p class="mx-auto mb-3" style="max-width:800px">Percayakan segala kebutuhan Anda kepada Dhans ID.</p>
          </div>
          <div class="row py-3">
            <div class="col-md-4 text-center mb-3" data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="bg-white border rounded p-3 mt-n4">
                <div class="h5 mt-3">Company Profile Website</div>
                <p class="text-small">Dhans ID menyediakan layanan pembuatan website untuk keperluan Website Landing Page, Company Profile, Toko Online, Micro Site dan lain-lain..</p><a class="btn btn-link" href="#Contact">Learn More<i class="fas fa-arrow-right ms-1"></i></a>
              </div>
            </div>
            <div class="col-md-4 text-center mb-3" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="bg-white border rounded p-3 mt-n4">
                <div class="h5 mt-3">Digital Marketing</div>
                <p class="text-small">Dhans ID menyediakan layanan analisis dan membuat strategi untuk melakukan pemasaran digital baik mengoptimasi sosial media, produk, jasa dan lain-lain..</p><a class="btn btn-link" href="#!">Learn More<i class="fas fa-arrow-right ms-1"></i></a>
              </div>
            </div>
            <div class="col-md-4 text-center mb-3" data-aos="fade-up" data-aos-delay="300">
              ...
              <div class="bg-white border rounded p-3 mt-n4">
                <div class="h5 mt-3">E-Commerce Marketing</div>
                <p class="text-small">Dhans ID membantu Anda memaksimalkan penjualan di Marketplace online, Tokopedia, Shopee, Tiktok Shop dan lain-lain..</p><a class="btn btn-link" href="#!">Learn More<i class="fas fa-arrow-right ms-1"></i></a>
              </div>
            </div>
            <div class="col-md-4 text-center mb-3" data-aos="fade-up" data-aos-delay="300">
              <div class="bg-white border rounded-circle d-inline-block p-2"><img class="p-2" src="images/services/web-design.svg" width="96" height="96" alt="web design" /></div>
              <div class="bg-white border rounded p-3 mt-n4">
                <div class="h5 mt-3">Social Media</div>
                <p class="text-small">Kami menyediakan layanan pengelolaan dan pembuatan konten untuk berbagai macam platform sosial media seperti, Facebook, Instagram, LinkedIn, TikTok dan lain-lain..</p><a class="btn btn-link" href="#!">Learn More<i class="fas fa-arrow-right ms-1"></i></a>
              </div>
            </div>
            <div class="col-md-4 text-center mb-3" data-aos="fade-up" data-aos-delay="300">
              <div class="bg-white border rounded-circle d-inline-block p-2"><img class="p-2" src="images/services/graphic-design.svg" width="96" height="96" alt="graphic design" /></div>
              <div class="bg-white border rounded p-3 mt-n4">
                ...
                <p class="text-small">Dhans ID juga memberikan layanan untuk membuat Website Anda berada di halaman pertama Google dengan kata kunci yang sudah Kami riset serta sesuai dengan produk/jasa bisnis Anda..</p><a class="btn btn-link" href="#!">Learn More<i class="fas fa-arrow-right ms-1"></i></a>
              </div>
            </div>
            <div class="col-md-4 text-center mb-3" data-aos="fade-up" data-aos-delay="300">
              <div class="bg-white border rounded-circle d-inline-block p-2"><img class="p-2" src="images/services/ui-ux.svg" width="96" height="96" alt="ui-ux" /></div>
              <div class="bg-white border rounded p-3 mt-n4">
                <div class="h5 mt-3">Design</div>
                <p class="text-small">Dhans ID memberikan solusi untuk bisnis Anda sehingga design produk dan jasa Anda terlihat lebih menarik dan mampu mendatangkan lebih banyak pelanggan..</p><a class="btn btn-link" href="#!">Learn More<i class="fas fa-arrow-right ms-1"></i></a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row px-4">
            <div class="col-md-3 col-sm-6">
              <div class="d-flex py-2"><i class="mr-3 fas fa-clipboard-check fa-4x fa-fw"></i>
                <div class="ms-1">
                  <div class="h2 mb-1 purecounter" data-purecounter-start="0" data-purecounter-end="221" data-purecounter-duration="1">221</div>
            ...
            <div class="col-md-3 col-sm-6">
              <div class="d-flex py-2"><i class="mr-3 fas fa-smile fa-4x fa-fw"></i>
                <div class="ms-1">
                  <div class="h2 mb-1 purecounter" data-purecounter-start="0" data-purecounter-end="267" data-purecounter-duration="1">267</div>
            ...
            <div class="col-md-3 col-sm-6">
              <div class="d-flex py-2"><i class="mr-3 fas fa-file-alt fa-4x fa-fw"></i>
                <div class="ms-1">
                  <div class="h2 mb-1 purecounter" data-purecounter-start="0" data-purecounter-end="124" data-purecounter-duration="1">124</div>
            ...
            <div class="col-md-3 col-sm-6">
              <div class="d-flex py-2"><i class="mr-3 fas fa-clock fa-4x fa-fw"></i>
                <div class="ms-1">
                  <div class="h2 mb-1 purecounter" data-purecounter-start="0" data-purecounter-end="4255" data-purecounter-duration="1">4255</div>
          ...
          <div class="container-narrow">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active" data-bs-interval="3000">
                <div class="row">
                  <div class="col-md-4">
                    <div class="card d-block mb-3"><img class="card-img-top" src="images/team/team-1.svg" alt="image" />
                      <div class="card-body text-center">
                        <div class="h5 mb-1">Saepul Ramadhan</div>
                        <div class="text-muted mb-1">CEO & Founder</div>
                  ...
                  <div class="col-md-4">
                    <div class="card d-block mb-3"><img class="card-img-top" src="images/team/team-2.svg" alt="image" />
                      <div class="card-body text-center">
                        <div class="h5 mb-1">Maulana Rahman</div>
                        <div class="text-muted mb-1">Manager</div>
                        <div class="nav text-light justify-content-center"><a class="nav-link" href="#!" title="Twitter"><i class="fab fa-twitter"></i><span class="menu-title sr-only">Twitter</span></a><a class="nav-link" href="#!" title="Facebook"><i class="fab fa-facebook"></i><span class="menu-title sr-only">Facebook</span></a><a class="nav-link" href="#!" title="Instagram"><i class="fab fa-instagram"></i><span class="menu-title sr-only">Instagram</span></a><a class="nav-link" href="#!" title="LinkedIn"><i class="fab fa-linkedin"></i><span class="menu-title sr-only">LinkedIn</span></a></div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="card d-block mb-3"><img class="card-img-top" src="images/team/emp-3.jpg" alt="image" />
                      <div class="card-body text-center">
                        <div class="h5 mb-1">Irda</div>
                        <div class="text-muted mb-1">Staff</div>
                        <div class="nav text-light justify-content-center"><a class="nav-link" href="#!" title="Twitter"><i class="fab fa-twitter"></i><span class="menu-title sr-only">Twitter</span></a><a class="nav-link" href="#!" title="Facebook"><i class="fab fa-facebook"></i><span class="menu-title sr-only">Facebook</span></a><a class="nav-link" href="#!" title="Instagram"><i class="fab fa-instagram"></i><span class="menu-title sr-only">Instagram</span></a><a class="nav-link" href="#!" title="LinkedIn"><i class="fab fa-linkedin"></i><span class="menu-title sr-only">LinkedIn</span></a></div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="card d-block mb-3"><img class="card-img-top" src="images/team/emp-4.jpg" alt="image" />
                      <div class="card-body text-center">
                        <div class="h5 mb-1">Bong Kiky</div>
                        <div class="text-muted mb-1">CFO</div>
                        <div class="nav text-light justify-content-center"><a class="nav-link" href="#!" title="Twitter"><i class="fab fa-twitter"></i><span class="menu-title sr-only">Twitter</span></a><a class="nav-link" href="#!" title="Facebook"><i class="fab fa-facebook"></i><span class="menu-title sr-only">Facebook</span></a><a class="nav-link" href="#!" title="Instagram"><i class="fab fa-instagram"></i><span class="menu-title sr-only">Instagram</span></a><a class="nav-link" href="#!" title="LinkedIn"><i class="fab fa-linkedin"></i><span class="menu-title sr-only">LinkedIn</span></a></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4">
                    <div class="card d-block mb-3"><img class="card-img-top" src="images/team/emp-5.jpg" alt="image" />
                      <div class="card-body text-center">
                        <div class="h5 mb-1">M Fajar Shidiq</div>
                        <div class="text-muted mb-1">Content Director</div>
                        <div class="nav text-light justify-content-center"><a class="nav-link" href="#!" title="Twitter"><i class="fab fa-twitter"></i><span class="menu-title sr-only">Twitter</span></a><a class="nav-link" href="#!" title="Facebook"><i class="fab fa-facebook"></i><span class="menu-title sr-only">Facebook</span></a><a class="nav-link" href="#!" title="Instagram"><i class="fab fa-instagram"></i><span class="menu-title sr-only">Instagram</span></a><a class="nav-link" href="#!" title="LinkedIn"><i class="fab fa-linkedin"></i><span class="menu-title sr-only">LinkedIn</span></a></div>
                      </div>
                    </div>
                  </div>
          ...
          <div class="grid bp-gallery pb-3" data-aos="zoom-in-up" data-aos-delay="100">
            ...
            <div class="grid-item"><a href="https://soundcloud.com/">
                <figure class="portfolio-item"><img src="images/portfolio/3-small.png" data-bp="images/portfolio/3.jpg" data-caption="Example of an optional caption." />
                  <figcaption>
                    <h4 class="h5 mb-0">Content Manager</h4>
            ...
            <div class="grid-item"><a href="https://www.adobe.com/">
                <figure class="portfolio-item"><img src="images/portfolio/4-small.png" data-bp="images/portfolio/4.jpg" />
                  <figcaption>
                    <h4 class="h5 mb-0">Videography</h4>
            ...
            <div class="grid-item"><a href="https://www.android.com/">
                <figure class="portfolio-item"><img src="images/portfolio/6-small.png" data-bp="images/portfolio/6.jpg" />
                  <figcaption>
                    <h4 class="h5 mb-0">Social Media</h4>
                    <!-- <div>Android</div> -->
                  </figcaption>
                </figure>
              </a></div>
            <div class="grid-item"><a href="https://flutter.dev/">
                <figure class="portfolio-item"><img src="images/portfolio/7-small.png" data-bp="images/portfolio/7.jpg" />
                  <figcaption>
                    <h4 class="h5 mb-0">Digital Marketing</h4>
                    <!-- <div>Flutter</div> -->
                  </figcaption>
                </figure>
              </a></div>
      ...
      <div class="section py-3 py-lg-5 px-2 px-lg-4" id="contact">
        <div class="container-narrow">
          <div class="text-center mb-5">
            <h2 class="marker marker-center">Hubungi Kami</h2>
          </div>
          <div class="row">
            <div class="col-md-6" data-aos="zoom-in" data-aos-delay="100">
              <div class="bg-light my-2 p-3 pt-2">
                ...
                <a href="https://api.whatsapp.com/send?phone=6281919843840&text=$name+Dhans+ID"><button class="btn btn-primary mt-2" type="submit">Send</button></a>
              </div>
            </div>
            <div class="col-md-6" data-aos="fade-left" data-aos-delay="300">
              <div class="mt-3 px-2">
                <div class="h5">Ayok hubungi Dhans ID sekarang juga!</div>
                <p>Jika Anda tertarik dengan layanan kami, silahkan tuliskan proposal Anda disini.</p>
                <p>Atau hubungi kami melalui Sosial Media yang tersedia.</p>
                <p>Kami tunggu!</p>
              </div>
              <div class="mt-5 px-2">
                <div class="row">
                  ...
                  <div class="col-sm-10">
                    <div class="pb-1 fw-bolder">info@dhans.id</div>
                  </div>
                  ...
                  <div class="col-sm-10">
                    <div class="pb-1 fw-bolder">+62 838-1122-3398</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer class="py-5 px-2 bg-light" id="footer">
        <div class="container">
          <div class="row">
            <div class="col-lg-4 col-md-12 mb-3">
              <div class="mb-3">
                <div class="h4">PT. Dhans Media Sinergi</div>
                <p class="text-muted">Digital Marketing Agency.</p>
              ...
              <div class="text-small text-muted">
                <div class="mb-1">&copy; Copyright <?php echo date('Y') ?> <strong>PT. Dhans Media Sinergi</strong>. All rights reserved.</div>
                <div>
                  <!-- Make sure to buy a license for the template before removing the line below. Buy license on https://templateflip.com/Design by <a href="https://templateflip.com/" target="_blank">TemplateFlip</a> -->
                </div>
              </div>
            </div>
        ...
        <div class="nav flex-column">
          <a class="nav-link px-0" href="#!">Design</a><a class="nav-link px-0" href="#!">Development</a><a class="nav-link px-0" href="#!">Branding</a><a class="nav-link px-0" href="#!">Marketing</a>
        </div> -->
            </div>
            <div class="col-lg-2 col-md-6 mb-3">
              <!-- <div class="text-uppercase mb-2">Products</div>
        <div class="nav flex-column">
          <a class="nav-link px-0" href="#!">Services</a><a class="nav-link px-0" href="#!">Portfolio</a><a class="nav-link px-0" href="#!">Team</a><a class="nav-link px-0" href="#!">Pricing</a>
        </div> -->
            </div>
            <div class="col-lg-2 col-md-6 mb-3">
              <!-- <div class="text-uppercase mb-2">About</div>
        <div class="nav flex-column">
          <a class="nav-link px-0" href="#!">About</a><a class="nav-link px-0" href="#!">Contact</a><a class="nav-link px-0" href="#!">Terms</a><a class="nav-link px-0" href="#!">Privacy</a>
        </div> -->
            </div>
            <div class="col-lg-2 col-md-6 mb-3">
              ...
              <div class="text-small">
                <address>
                  Sentraland Paradise,<br />
                  Parungpanjang, Bogor<br />
                  Indonesia
                </address>
                <div class="mb-1"><strong>Phone:</strong><br />+62 838-1122-3398</div>
                <div class="mb-1"><strong>Email:</strong><br />info@dhans.id</div>
              </div>
            </div>
          </div>
        </div>
